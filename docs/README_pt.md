...
[![Tests](https://img.shields.io/badge/tests-321%20passed-0d7377?style=flat-square)](#testes)
...
[![Coverage](https://img.shields.io/badge/coverage-93%25-0d7377?style=flat-square)](#testes)
...
<td align="center"><strong>321</strong><br><sub>Testes</sub></td>
...
```bash
pytest tests/ -v                          # Todos os 321 testes
