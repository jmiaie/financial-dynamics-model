...
[![Tests](https://img.shields.io/badge/tests-321%20passed-0d7377?style=flat-square)](#pruebas)
...
[![Coverage](https://img.shields.io/badge/coverage-93%25-0d7377?style=flat-square)](#pruebas)
...
<td align="center"><strong>321</strong><br><sub>Pruebas</sub></td>
...
```bash
pytest tests/ -v                          # Las 321 pruebas
