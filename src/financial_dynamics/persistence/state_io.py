...
def _extract_feature_engine_state(fe: Any) -> dict[str, Any]:
    return {
...
def _extract_transition_engine_state(te: Any) -> dict[str, Any]:
    return {
...
def _extract_stabilization_engine_state(se: Any) -> dict[str, Any]:
    return {
...
def _extract_risk_engine_state(re: Any) -> dict[str, Any]:
    return {
...
def _restore_feature_engine_state(fe: Any, fe_state: dict[str, Any]) -> None:
...
def _restore_transition_engine_state(te: Any, te_state: dict[str, Any]) -> None:
...
def _restore_stabilization_engine_state(se: Any, se_state: dict[str, Any]) -> None:
...
def _restore_risk_engine_state(re: Any, re_state: dict[str, Any]) -> None:
